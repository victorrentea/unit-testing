...
//      when(timeProvider.currentDate()).thenReturn(parse("2021-09-21"));


      when(orderRepo.findByCustomerIdAndCreatedOnBetween(
          13, parse("2021-09-14"), parse("2021-09-21"))).thenReturn(List.of(new Order().setTotalAmount(130d)));
      LocalDate testTime = parse("2021-09-21");
   ...
   @Test
   void isFrequentBuyerParam() {
      when(orderRepo.findByCustomerIdAndCreatedOnBetween(
          13, parse("2021-09-14"), parse("2021-09-21"))).thenReturn(List.of(new Order().setTotalAmount(130d)));
      LocalDate testTime = parse("2021-09-21");

      boolean result = target.isFrequentBuyer(13, testTime);
