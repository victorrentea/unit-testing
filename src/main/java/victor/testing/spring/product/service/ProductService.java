...
//  @Async // extremely dangerous> my advice: Avoid testign code using multhreading
//  @Transactional(propagation = Propagation.REQUIRES_NEW)// KO @Transactional TEst
...
//    Supplier supplier = supplierRepo.getReferenceById(productDto.getSupplierId()); // returns a proxy
    Supplier supplier = new Supplier().setId(productDto.supplierId);
