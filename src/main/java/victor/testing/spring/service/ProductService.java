...
//  @Async
  public Long createProduct(ProductDto productDto) {
    ...
    kafkaTemplate.send(PRODUCT_CREATED_TOPIC, "key", event); // a 'tenant-id' message header is added by victor.testing.spring.config.AddTenantIdToSentMessagesInterceptor
    return productId;
  }
